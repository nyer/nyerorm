...
strFrame+='         onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" title="将日期置空">清空</span>&nbsp;&nbsp;<span onclick="parent.meizzToday()" style="font-size:12px;cursor: hand"';
strFrame+='         onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'" title="当前日期时间">当天</span>&nbsp;&nbsp;<span style="cursor:hand" id=evaAllOK onmouseover="style.color=\'#ff0000\'" onmouseout="style.color=\'#1478eb\'"  onclick="parent.closeLayer()" title="关闭日历">关闭&nbsp;</span></td></tr>';
...
function setdayCalBack(tt,obj,callBack,clearBack){	//包含回调函数
	callBackFn = callBack;
	clearBackFn = clearBack;
	if(obj == null){
		setday(tt);
	}else{
		setday(tt, obj);
...
document.onclick = function(){
	if(outObject != null && outObject.tagName != "INPUT"){
		return null;
	}
